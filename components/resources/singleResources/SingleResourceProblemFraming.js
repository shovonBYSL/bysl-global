...
const SingleResourceProblemFraming = ({ data }) => {
  return (
    <div className="resource-box py-10 xl:py-16">
      ...
      <p className="mt-6 text-gray-600 text-center w-11/12 sm:w-4/5 lg:w-3/5 2xl:w-1/2 mx-auto mb-10 xl:mb-16">
      ...
      <div className="h-max w-full bg-[url('/images/resources/single/problem_bg.svg')] bg-cover bg-center bg-no-repeat">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-y-10 mx-6 sm:mx-10 lg:mx-28">
          {data.map(({ id, title, subTitle, img, type1, type2 }) => {
            return (
              <div
                key={id}
              ...
              >
                <div className="flex items-center justify-between mb-16">
                  <p className="xl:text-lg 2xl:text-xl font-extrabold text-gray-600">
                    {title}
                  </p>
                ...
                <div className="flex items-center gap-1.5">
                  <p className="text-gray-600 font-medium text-sm xl:text-base">
                    {type1}
                  </p>
