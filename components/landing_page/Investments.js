      ...
      <div className="grid grid-cols-1 xs:grid-cols-2 gap-4 xl:gap-6 3xl:gap-10">
        <Link passHref href="/investments#it-platform">
          <a className="3xl:h-[610px] rounded-[10px] xl:rounded-[20px] bg-white pb-8 xl:pb-16 flex flex-col justify-between">
            <div className=" max-w-[640px] max-h-[640px] relative">
              {/* <Image
                src={data.ITPlatform}
                placeholder="blur"
              ...
              <div className="animate_logo absolute top-[30%] lg:top-[28%] left-1/2 translate-x-[-50%] max-w-[94px] max-h-[94px]">
                <div className="h-[40px] w-[40px] md:h-[50px] md:w-[50px] lg:h-[60px] lg:w-[60px] xl:h-[70px] xl:w-[70px] 2xl:h-[94px] 2xl:w-[94px] bg-white rounded-xl  2xl:rounded-[20px] shadow-[0px_4px_8px_rgba(8,76,148,0.08)] flex items-center justify-center">
                  <div className="relative h-8 lg:h-12 w-8 lg:w-12 xl:h-14 xl:w-14">
                    <Image
                      src={data.live}
                      placeholder="blur"
