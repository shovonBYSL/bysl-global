      ...
      <div className="flex flex-col sm:flex-row justify-between sm:gap-4 sm:items-center xl:items-start">
        <div className="sm:w-1/2 text-center sm:text-start xl:mt-8 3xl:mt-16 mb-11 sm:mb-0">
          ...
          <p className="text-white/75 leading-4 text-sm lg:text-base 2xl:text-lg 3xl:text-xl max-w-[450px]">
            Whether it's subtle interactions that improve the UX, or a complete
            restructuring of virtual networks, or hardforking of difficult
            systems, or building comprehensive software frameworks for massive
            business projects, we provide class-leading sustainable solutions
            catalyzing exponential and sustainable growth.
          </p>
        </div>
