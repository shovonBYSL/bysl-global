...
const purposeCardData = [
  ...
  },
  {
    ...
    description:
      "Investment at BYSL Global follows the steps of exploration and innovation. The validation and refinement of ideas and innovation in any field must pass a certain bench mark before getting selected for capital investment. We only make long-term investments where we can create an impact at scale. What differentiates BYSL Global from any other business organization is its purpose of investments. The aim of our investment goes beyond profit-making. Our investments are guided by our vision to establish a better future for everyone. We invest in meaningful ventures through which we can make socio-economic contributions.",
    img: "purpose_card_1",
  },
  {
    id: 2,
...
const cultureCardData = [
  ...
  },
  {
    ...
    title: "Learning",
    description:
      "BYSL Global promotes  and nurtures a culture  of  learning  that  is  structured, validated, and productive. More precisely, the promoted learning process should go through a continuous experimentation and feedback cycle based on data and metrics. Learning at the premise of BYSL Global aims and carries the potential to spur incremental and disruptive innovation in all relevant fields. Apart from structured and validated learning, employees are encouraged to keep an open mind to learn from mistkes and explore new solutions to problems. For steady growth and development of the organization, learning plays a vital role, and every employee is expected to be an active learner.",
    img: "culture_card_1",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    title: "Innovation",
    description:
      "Rising from the ambition to serve the world with  exceptional  products  and  services, BYSL Global  has weaved  the culture  of innovation  at  the  very  heart  of  the organization. Inspiring continuous explora- tions through systematic experimentations, our culture fuels innovation in a way that ushers a stream of new ideas and concepts for  exceptional  products  and  services. Exceptional  products  and  services  are empowering, and they excel in creativity and  productivity;  they  work  as  an enhancement of life. We aspire to develop innovative products and services to touch  and  change  people's  lives  and  add  quality  to  them.  We  aspire  to revolutionize the life and work of our valued customers by ascending to the next curve of innovation, unfolding the hidden blessings of life that we all are subjected to. Everyone belonging to the organization devotes their full potential to keep the engine of innovation revving.",
    img: "culture_card_5",
  },
  {
    id: 6,
